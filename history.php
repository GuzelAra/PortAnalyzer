	...
	<head>
		...
		<body>
			...
			<?php
				...
				$db_table = "deals_history"; // Имя Таблицы БД
				$sym = "*";
				...
				echo "<th>Цена</th>";
				echo "<th>Комиссия</th>";
				echo "<th>Монета комиссии</th>";
				echo "<th>Комиссия в USDT</th>";
				echo "<th>Цена сделки</th>";
				echo "<th>Тип сделки</th>";
				echo "<th>ID сделки</th>";
				echo "</tr>";
				echo "</thead>";
				...
				while ($History = mysqli_fetch_array($sql)) {
					...
					echo "<th>".$History['time']."</th>";
					echo "<th>".$History['CurrencyPair']."</th>";
					echo "<th>".$History['Count']."</th>";
					echo "<th>$".$History['Price']."</th>";
					echo "<th>".$History['Fee']."</th>";
					echo "<th>".$History['FeeCoin']."</th>";
					echo "<th>$".$History['FeeUSDT']."</th>";
					echo "<th>$".$History['DealPrice']."</th>";
					echo "<th>".$History['DealType']."</th>";
					echo "<th>".$History['DealID']."</th>";
					echo "</tr>";
					
					$SumDeals = $SumDeals + 1;
					$SumFeeUSDT = $SumFeeUSDT + $History['FeeUSDT'];
				
				};
				
				
				echo "<tr>";
				echo "<th><b>СДЕЛОК ВСЕГО</b></th>";
				echo "<th><b>".$SumDeals." шт.</b></th>";
				echo "<th></th>";
				echo "<th></th>";
				echo "<th></th>";
				echo "<th></th>";
				echo "<th><b>ОПЛАЧЕНО КОМИССИИ</b></th>";
				echo "<th><b>$".round($SumFeeUSDT, 2)."</b></th>";
				echo "<th></th>";
				echo "<th></th>";
				echo "<th></th>";
				echo "</tr>";
